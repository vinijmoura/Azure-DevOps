...
$PAT = 'olfz56uhtqrms5zmrshy2oqmi4zobyzzlwrtfwyoyntrlku5wm4a'
$Organization = 'vstssprints'
$Connstr = 'Server=tcp:azuredevopsresports.database.windows.net,1433;Initial Catalog=azuredevopsresports-db;Persist Security Info=False;User ID=azuredevopsresports;Password=Reports@123!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'
